...
<html lang="fr" dir="ltr">
    <head>
        ...
        <title>Exercice1P9</title>
    </head>
    <body>
        <header>
            <div class="jumbotron text-center">
                <h1 class="display-3 text-center">Exercice 1 partie 9</h1>
                <p class="lead text-center">Afficher la date courante en respectant la forme jj/mm/aaaa (ex : 16/05/2016)</p>
            </div>
