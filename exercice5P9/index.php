    ...
    <body>
        ...
        <main>
            <div class="php text-center">
                <p>
                    <?php
                    //Création des variables date1 et date2 avec strtotime() afin de les formater en timestamp
                        $date1 = strtotime('16-05-2016');
                        $date2 = strtotime('12-06-2019');
                        $nbTimestamp = $date2 - $date1;
                        echo $nbTimestamp/86400;
                    ?>
                </p>
            </div>
        </main>
