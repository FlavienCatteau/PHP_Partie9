...
<html lang="fr" dir="ltr">
    <head>
        ...
        <title>Exercice8P9</title>
    </head>
    <body>
        <header>
            <div class="jumbotron text-center">
                <h1 class="display-3 text-center">Exercice 8 partie 9</h1>
                <p class="lead text-center">Afficher la date du jour - 22 jours</p>
            </div>
            ...
            <div class="php text-center">
                <p>
                    <?php
                        ...
                        $timestamp2 = $timestamp - 1900800; //on retire 22 jours en secondes 86 400 (Pour 1 jour en seconde) * 22 pour 22 jours.
